...
import edmt.bar.hungers.Admin.AdminNewOrdersActivity;
import edmt.bar.hungers.Admin.AdminPreviousOrders;
import edmt.bar.hungers.Admin.AdminUserProductsActivity;
                    ...
                    protected void onBindViewHolder(@NonNull AdminNewOrdersActivity.AdminOrdersViewHolder holder, final int position, @NonNull final AdminOrders model)
                    {
                        ...
                        holder.ShowOrdersBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view)
                            {
                                ...
                                Intent intent = new Intent(UserOrders.this, AdminUserProductsActivity.class);
